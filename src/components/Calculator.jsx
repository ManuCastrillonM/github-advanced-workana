...
const Calculator = () => {
    ...
    const magicSum = (number) => {
        console.log(`%c ${number} `, 'background: #222; color: #bada55; font-size: 20px;');
    };
        ...
        <div className="container">
            ...
            <div className="area-calculator">
                ...
                <div>
                    ...
                    <input id="circleRadius" type="number" value={circleRadius} onChange={(e) => setCircleRadius(e.target.value)} />
                    <button onClick={calculateCircleArea}>Calculate Circle Area</button>
                </div>
                <div>
                    <label htmlFor="triangleBase">Triangle Base:</label>
                    <input id="triangleBase" type="number" value={triangleBase} onChange={(e) => setTriangleBase(e.target.value)} />
                    <label htmlFor="triangleHeight">Triangle Height:</label>
                    <input id="triangleHeight" type="number" value={triangleHeight} onChange={(e) => setTriangleHeight(e.target.value)} />
                    <button onClick={calculateTriangleArea}>Calculate Triangle Area</button>
                </div>
                <div>
                    <label htmlFor="squareSide">Square Side:</label>
                    <input id="squareSide" type="number" value={squareSide} onChange={(e) => setSquareSide(e.target.value)} />
