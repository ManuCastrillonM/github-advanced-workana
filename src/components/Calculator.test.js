...
test('calculates area of a circle', () => {
    ...
    fireEvent.change(getByLabelText('Circle Radius:'), { target: { value: '5' } });
...
test('calculates area of a triangle', () => {
    ...
    fireEvent.change(getByLabelText('Triangle Base:'), { target: { value: '10' } });
    fireEvent.change(getByLabelText('Triangle Height:'), { target: { value: '5' } });
